...
$manifest = array (
  ...
  'name' => 'BTCRM',
  'published_date' => '2023-02-08 04:47:12',
  'type' => 'module',
  'version' => 1675831632,
...
$installdefs = array (
  ...
  array (
    ...
    array (
      ...
      'class' => 'BT_chitietdonhang_bt',
      'path' => 'modules/BT_chitietdonhang_bt/BT_chitietdonhang_bt.php',
      'tab' => true,
    ),
    1 => 
    array (
  ...
  array (
    0 => 
    array (
      'from' => '<basepath>/SugarModules/relationships/layoutdefs/bt_chitietdonhang_bt_accounts_BT_chitietdonhang_bt.php',
      'to_module' => 'BT_chitietdonhang_bt',
    ),
    1 => 
    array (
      'from' => '<basepath>/SugarModules/relationships/layoutdefs/bt_chitietdonhang_bt_bt_sanpham_bt_BT_chitietdonhang_bt.php',
      'to_module' => 'BT_chitietdonhang_bt',
    ),
    2 => 
    array (
  ...
  array (
    0 => 
    array (
      'meta_data' => '<basepath>/SugarModules/relationships/relationships/bt_chitietdonhang_bt_accountsMetaData.php',
    ),
    1 => 
    array (
      'meta_data' => '<basepath>/SugarModules/relationships/relationships/bt_chitietdonhang_bt_bt_sanpham_btMetaData.php',
    ),
    2 => 
    array (
  ...
  array (
    0 => 
    array (
      'from' => '<basepath>/SugarModules/modules/BT_chitietdonhang_bt',
      'to' => 'modules/BT_chitietdonhang_bt',
    ),
    1 => 
    array (
  ...
  array (
    ...
    1 => 
    array (
      'from' => '<basepath>/SugarModules/relationships/language/BT_chitietdonhang_bt.php',
      'to_module' => 'BT_chitietdonhang_bt',
      'language' => 'en_us',
    ),
    2 => 
  ...
  array (
    0 => 
    array (
      'from' => '<basepath>/SugarModules/relationships/vardefs/bt_chitietdonhang_bt_accounts_Accounts.php',
      'to_module' => 'Accounts',
    ),
    1 => 
    array (
      'from' => '<basepath>/SugarModules/relationships/vardefs/bt_chitietdonhang_bt_accounts_BT_chitietdonhang_bt.php',
      'to_module' => 'BT_chitietdonhang_bt',
    ),
    2 => 
    array (
      'from' => '<basepath>/SugarModules/relationships/vardefs/bt_chitietdonhang_bt_bt_sanpham_bt_BT_sanpham_bt.php',
      'to_module' => 'BT_sanpham_bt',
    ),
    3 => 
    array (
      'from' => '<basepath>/SugarModules/relationships/vardefs/bt_chitietdonhang_bt_bt_sanpham_bt_BT_chitietdonhang_bt.php',
      'to_module' => 'BT_chitietdonhang_bt',
    ),
    4 => 
    array (
  ...
  array (
    ...
    array (
      'additional_fields' => 
      array (
        'Accounts' => 'bt_chitietdonhang_bt_accounts_name',
      ),
    ),
    1 => 
    array (
