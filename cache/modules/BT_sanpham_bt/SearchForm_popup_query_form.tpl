...
<tr>
	...
	<td scope="row" nowrap="nowrap" width='10%' >
			<label for='name_advanced'>{sugar_translate label='LBL_NAME' module='BT_sanpham_bt'}</label>
		</td>
...
<input type='text' name='{$fields.name_advanced.name}' 
	...
	<td scope="row" nowrap="nowrap" width='10%' >
		...
		<label for='assigned_user_id_advanced'>{sugar_translate label='LBL_ASSIGNED_TO' module='BT_sanpham_bt'}</label>
    	</td>
	<td  nowrap="nowrap" width='30%'>
