...
<tr>
	...
	<td scope="row" nowrap="nowrap" width='1%' >
			<label for='name_basic'> {sugar_translate label='LBL_NAME' module='BT_chitietdonhang_bt'}
		</td>
...
<input type='text' name='{$fields.name_basic.name}' 
	...
	<td scope="row" nowrap="nowrap" width='1%' >
		...
		<label for='current_user_only_basic' >{sugar_translate label='LBL_CURRENT_USER_FILTER' module='BT_chitietdonhang_bt'}</label>
    	</td>
