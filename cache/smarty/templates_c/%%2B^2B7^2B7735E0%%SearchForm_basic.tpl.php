<?php /* Smarty version 2.6.11, created on 2023-02-11 17:48:48
         compiled from cache/modules/BT_nhacungcap_bt/SearchForm_basic.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'counter', 'cache/modules/BT_nhacungcap_bt/SearchForm_basic.tpl', 33, false),array('function', 'math', 'cache/modules/BT_nhacungcap_bt/SearchForm_basic.tpl', 34, false),array('function', 'sugar_translate', 'cache/modules/BT_nhacungcap_bt/SearchForm_basic.tpl', 43, false),array('function', 'sugar_getimagepath', 'cache/modules/BT_nhacungcap_bt/SearchForm_basic.tpl', 101, false),array('modifier', 'count', 'cache/modules/BT_nhacungcap_bt/SearchForm_basic.tpl', 88, false),)), $this); ?>
...
<tr>
	...
	<td scope="row" nowrap="nowrap" width='1%' >
			<label for='name_basic'> <?php echo smarty_function_sugar_translate(array('label' => 'LBL_NAME','module' => 'BT_nhacungcap_bt'), $this);?>
...
' title=''      accesskey='9'  >
	...
	<td scope="row" nowrap="nowrap" width='1%' >
		...
		<label for='current_user_only_basic' ><?php echo smarty_function_sugar_translate(array('label' => 'LBL_CURRENT_USER_FILTER','module' => 'BT_nhacungcap_bt'), $this);?>
</label>
    	</td>
...
</table><?php echo '<script language="javascript">if(typeof sqs_objects == \'undefined\'){var sqs_objects = new Array;}sqs_objects[\'search_form_modified_by_name_basic\']={"form":"search_form","method":"get_user_array","field_list":["user_name","id"],"populate_list":["modified_by_name_basic","modified_user_id_basic"],"required_list":["modified_user_id"],"conditions":[{"name":"user_name","op":"like_custom","end":"%","value":""}],"limit":"30","no_match_text":"No Match"};sqs_objects[\'search_form_created_by_name_basic\']={"form":"search_form","method":"get_user_array","field_list":["user_name","id"],"populate_list":["created_by_name_basic","created_by_basic"],"required_list":["created_by"],"conditions":[{"name":"user_name","op":"like_custom","end":"%","value":""}],"limit":"30","no_match_text":"No Match"};sqs_objects[\'search_form_assigned_user_name_basic\']={"form":"search_form","method":"get_user_array","field_list":["user_name","id"],"populate_list":["assigned_user_name_basic","assigned_user_id_basic"],"required_list":["assigned_user_id"],"conditions":[{"name":"user_name","op":"like_custom","end":"%","value":""}],"limit":"30","no_match_text":"No Match"};sqs_objects[\'search_form_bt_sanpham_bt_bt_nhacungcap_bt_name_basic\']={"form":"search_form","method":"query","modules":["BT_sanpham_bt"],"group":"or","field_list":["name","id"],"populate_list":["bt_sanpham_bt_bt_nhacungcap_bt_name_basic","bt_sanpham_bt_bt_nhacungcap_btbt_sanpham_bt_ida_basic"],"required_list":["parent_id"],"conditions":[{"name":"name","op":"like_custom","end":"%","value":""}],"order":"name","limit":"30","no_match_text":"No Match"};</script>'; ?>