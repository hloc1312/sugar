<?php /* Smarty version 2.6.11, created on 2023-02-11 03:57:09
         compiled from cache/modules/BT_donhang_bt/SearchForm_popup_query_form.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'counter', 'cache/modules/BT_donhang_bt/SearchForm_popup_query_form.tpl', 26, false),array('function', 'math', 'cache/modules/BT_donhang_bt/SearchForm_popup_query_form.tpl', 27, false),array('function', 'sugar_getimagepath', 'cache/modules/BT_donhang_bt/SearchForm_popup_query_form.tpl', 35, false),array('function', 'sugar_translate', 'cache/modules/BT_donhang_bt/SearchForm_popup_query_form.tpl', 44, false),array('function', 'html_options', 'cache/modules/BT_donhang_bt/SearchForm_popup_query_form.tpl', 84, false),array('function', 'sugar_getimage', 'cache/modules/BT_donhang_bt/SearchForm_popup_query_form.tpl', 97, false),)), $this); ?>
...
' class="help-search">
	...
	<td scope="row" nowrap="nowrap" width='10%' >
			<label for='name_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_NAME','module' => 'BT_donhang_bt'), $this);?>
</label>
		</td>
...
' class="help-search">
	...
	<td scope="row" nowrap="nowrap" width='10%' >
		...
		<label for='assigned_user_id_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_ASSIGNED_TO','module' => 'BT_donhang_bt'), $this);?>
</label>
    	</td>
	<td  nowrap="nowrap" width='30%'>
...
</script><?php echo '<script language="javascript">if(typeof sqs_objects == \'undefined\'){var sqs_objects = new Array;}sqs_objects[\'popup_query_form_modified_by_name_advanced\']={"form":"popup_query_form","method":"get_user_array","field_list":["user_name","id"],"populate_list":["modified_by_name_advanced","modified_user_id_advanced"],"required_list":["modified_user_id"],"conditions":[{"name":"user_name","op":"like_custom","end":"%","value":""}],"limit":"30","no_match_text":"No Match"};sqs_objects[\'popup_query_form_created_by_name_advanced\']={"form":"popup_query_form","method":"get_user_array","field_list":["user_name","id"],"populate_list":["created_by_name_advanced","created_by_advanced"],"required_list":["created_by"],"conditions":[{"name":"user_name","op":"like_custom","end":"%","value":""}],"limit":"30","no_match_text":"No Match"};sqs_objects[\'popup_query_form_assigned_user_name_advanced\']={"form":"popup_query_form","method":"get_user_array","field_list":["user_name","id"],"populate_list":["assigned_user_name_advanced","assigned_user_id_advanced"],"required_list":["assigned_user_id"],"conditions":[{"name":"user_name","op":"like_custom","end":"%","value":""}],"limit":"30","no_match_text":"No Match"};sqs_objects[\'popup_query_form_ten_khachhang_c_advanced\']={"form":"popup_query_form","method":"query","modules":["BT_khachhang_bt"],"group":"or","field_list":["name","id"],"populate_list":["ten_khachhang_c_advanced","bt_khachhang_bt_id_c_advanced"],"required_list":["parent_id"],"conditions":[{"name":"name","op":"like_custom","end":"%","value":""}],"order":"name","limit":"30","no_match_text":"No Match"};sqs_objects[\'popup_query_form_khachhang_name_advanced\']={"form":"popup_query_form","method":"query","modules":["BT_khachhang_bt"],"group":"or","field_list":["name","id"],"populate_list":["khachhang_name_advanced","khachhang_id_advanced"],"required_list":["parent_id"],"conditions":[{"name":"name","op":"like_custom","end":"%","value":""}],"order":"name","limit":"30","no_match_text":"No Match"};</script>'; ?>