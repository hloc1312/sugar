<?php /* Smarty version 2.6.11, created on 2023-02-11 17:48:01
         compiled from cache/modules/BT_khachhang_bt/DetailView.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'sugar_include', 'cache/modules/BT_khachhang_bt/DetailView.tpl', 33, false),array('function', 'counter', 'cache/modules/BT_khachhang_bt/DetailView.tpl', 38, false),array('function', 'sugar_translate', 'cache/modules/BT_khachhang_bt/DetailView.tpl', 47, false),array('function', 'sugar_number_format', 'cache/modules/BT_khachhang_bt/DetailView.tpl', 75, false),array('modifier', 'strip_semicolon', 'cache/modules/BT_khachhang_bt/DetailView.tpl', 48, false),)), $this); ?>
...
" class="button primary" onclick="var _form = document.getElementById('formDetailView'); _form.return_module.value='BT_khachhang_bt'; _form.return_action.value='DetailView'; _form.return_id.value='<?php echo $this->_tpl_vars['id']; ?>
...
" class="button" onclick="var _form = document.getElementById('formDetailView'); _form.return_module.value='BT_khachhang_bt'; _form.return_action.value='DetailView'; _form.isDuplicate.value=true; _form.action.value='EditView'; _form.return_id.value='<?php echo $this->_tpl_vars['id']; ?>
...
" class="button" onclick="var _form = document.getElementById('formDetailView'); _form.return_module.value='BT_khachhang_bt'; _form.return_action.value='ListView'; _form.action.value='Delete'; if(confirm('<?php echo $this->_tpl_vars['APP']['NTC_DELETE_CONFIRMATION']; ?>
...
" class="button" onclick="var _form = document.getElementById('formDetailView'); _form.return_module.value='BT_khachhang_bt'; _form.return_action.value='DetailView'; _form.return_id.value='<?php echo $this->_tpl_vars['id']; ?>
...
<div id="BT_khachhang_bt_detailview_tabs"
>
<div >
...
<td width='12.5%' scope="col">
<?php if (! $this->_tpl_vars['fields']['age']['hidden']):  ob_start();  echo smarty_function_sugar_translate(array('label' => 'LBL_AGE','module' => 'BT_khachhang_bt'), $this); $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean();  echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
<?php endif; ?>
</td>
<td width='37.5%'  >
<?php if (! $this->_tpl_vars['fields']['age']['hidden']):  echo smarty_function_counter(array('name' => 'panelFieldCount'), $this);?>
...
<td width='12.5%' scope="col">
<?php if (! $this->_tpl_vars['fields']['gender']['hidden']):  ob_start();  echo smarty_function_sugar_translate(array('label' => 'LBL_GENDER','module' => 'BT_khachhang_bt'), $this); $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean();  echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
<?php endif; ?>
</td>
<td width='37.5%'  >
<?php if (! $this->_tpl_vars['fields']['gender']['hidden']):  echo smarty_function_counter(array('name' => 'panelFieldCount'), $this);?>
